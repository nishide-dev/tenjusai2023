    ...
    return (
        <>
            <section className="px-10 py-20 bg-white">
                ...
                <div className="container flex flex-wrap justify-center mx-auto my-6">
                    {
                            ...
                            return (
                                <div key={index} className="flex items-center justify-center w-full p-3 md:p-3 align-middle md:w-1/2 xl:w-1/3 2xl:w-1/4">
                                    <FadeInToUp className="">
                                        <Image src={supporter.thumbnail_link} alt={supporter.name} height={600} width={600} className="object-contain max-h-10 md:max-h-12 lg:max-h-14 xl:max-h-16" />
                                    </FadeInToUp>
                                </div>
                            )
                        })
                    ...
                    <div className="container flex flex-wrap justify-center mx-auto my-5">
                        {
                            banners.map((banner, index) => {
                                if (!banner.link) {
                                    return (
                                        <FadeInToUp key={banner.name}>
                                            <Image src={banner.thumbnail_link} alt={banner.alt} height={400} width={400} />
                                        </FadeInToUp>
                                    )
                                }}
                            )
